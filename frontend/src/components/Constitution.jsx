                    ...
                    <div className="lg:col-span-3">
                        <div className="glass-card rounded-2xl p-8 shadow-lg">
                            <div className="flex flex-col gap-6 mb-8">
                                ...
                                {/* DigiLawyer Chat UI */}
                                <div className="bg-zinc-950 rounded-xl border border-zinc-800 overflow-hidden flex flex-col h-[500px]">
                                    {/* Chat Header */}
                                    <div className="bg-indigo-900/40 border-b border-zinc-800 p-4 flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-indigo-400">AI Constitutional Expert</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex-1 overflow-y-auto p-4 space-y-4 custom-scrollbar">
                                        {chatMessages.map((msg, idx) => (
                                            <div key={idx} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                                <div className={`max-w-[80%] rounded-2xl p-4 ${msg.role === 'user' ? 'bg-amber-500 text-black rounded-tr-sm' : 'bg-zinc-900 border border-zinc-800 text-zinc-200 rounded-tl-sm'}`}>
                                                    ...
                                                    <div className="whitespace-pre-wrap text-sm leading-relaxed">
                                                        {/* Simple markdown bolding for display */}
                            ...
                            </div>                            <div onMouseUp={handleTextSelection} className="prose prose-lg max-w-none transition-all duration-500 ease-in-out">
                                {loading ? (
